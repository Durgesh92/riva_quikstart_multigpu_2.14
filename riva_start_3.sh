...
gpus_to_use_new="device=2"
riva_speech_api_port_new=50053
...
if [ $(docker ps -q -f "name=^/$riva_daemon_speech_new$" | wc -l) -eq 0 ]; then
    ...
    if [[ $riva_target_gpu_family == "tegra" ]]; then
        docker_run_args="-p 8020:8020 -p 8021:8021 -p 8022:8022 -p 8828:8828 --device /dev/bus/usb --device /dev/snd"
    else
        docker_run_args="-p 8020 -p 8021 -p 8022"
    fi
